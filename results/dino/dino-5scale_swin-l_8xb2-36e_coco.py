...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='/root/dataset_clp/dataset_2044_new/valid/valid.json',
    metric='bbox',
    format_only=False,
    backend_args=None)
test_dataloader = dict(
    ...
    dataset=dict(
        type='CLP',
        data_root='/root/dataset_clp/dataset_2044_new/',
        ann_file='/root/dataset_clp/dataset_2044_new/test/test.json',
...
test_evaluator = dict(
    ...
    format_only=False,
    backend_args=None,
    outfile_prefix='./work_dirs/clp_detection/dino_2044_new_50_1280/')
default_scope = 'mmdet'
default_hooks = dict(
    ...
    checkpoint=dict(
        ...
        interval=5,
        save_best='auto',
        out_dir='/root/mmdetection/work_dirs/dino_2044_new_1280_60'),
