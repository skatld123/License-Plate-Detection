model = dict(
    ...
    data_preprocessor=dict(
        ...
        bgr_to_rgb=True,
        pad_size_divisor=32,
        batch_augments=[dict(type='BatchFixedSizePad', size=(896, 896))]),
    backbone=dict(
        type='EfficientNet',
        arch='b3',
        drop_path_rate=0.2,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='/root/dataset_clp/annotations/instances_val2017.json',
    metric='bbox',
    format_only=False,
    backend_args=None)
test_dataloader = dict(
    ...
    dataset=dict(
        type='CLP',
        data_root='/root/dataset_clp/',
        ann_file='/root/dataset_clp/annotations/instances_test2017.json',
