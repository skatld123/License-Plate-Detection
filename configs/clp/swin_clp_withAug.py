...
#     /root/mmdetection/configs/clp/swin_clp_withAug.py \
#     2 \
# 테스트
# ./tools/dist_test.sh \
...
max_epochs = 50
data_root = '/root/dataset_clp/dataset_2044_new_addResize/'
work_dir = '/root/mmdetection/work_dirs/swin_2044_new_addResize' + str(max_epochs) +"_withAug"
...
test_evaluator = dict(
    outfile_prefix='./work_dirs/clp_detection/swin_2044_new_50_withAug_addResize/')